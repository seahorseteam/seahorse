...
import ac.seahorse.seahorselockscreen.lockscreen.view.TestView;
...
public class LockScreenService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		MyDBG.log("onStartCommand");
		// 추후 "Word" 부분은 단어, "Mean" 부분은 뜻 불러오기.
